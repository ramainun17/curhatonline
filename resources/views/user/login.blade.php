    ...
    <div class="container log-card">
        <div class="card-log">
            ...
            <form action="{{ route('login.action') }}" method="POST">
                ...
                <br><br><br>
                <h4 class="log-text" style="text-decoration: none;">Login</h4>

                <label class="form-label">Username <span class="text-danger">*</span></label>
                <input class="form-control frm-c" type="username" name="username" value="{{ old('username') }}" />


                <label class="mt-3 col-form-label">Password <span class="text-danger">*</span></label>
                <input class="form-control frm-c mb-5" type="password" name="password" />

                    
                <button class="btn-log" style="text-decoration: none;">Login</button>
                <br><br><br>
                <p style="font-size: 14px; font-weight: 500;">Belum memiliki akun? <span> <a
                            href="{{ route('register') }}">Daftar disini</a></span></p>
            </form>
        </div>
    </div>
